...
# creates GUI
root = Tk()
root.title("Untitled - PyEdit Text Editor")
...
# create new file
def new(self):
    if root.title() == "Untitled - PyEdit Text Editor":
        # There is content?
                ...
                if root.filename:
                    try:
                        with open(root.filename, "r", encoding="utf8") as w:
                            e.delete(0.0, END)
                            root.title(os.path.basename(root.filename) + " - PyEdit Text Editor")
                            e.insert(END, w.read())
                    except:
                    ...
                    if x:
                        try:
                            with open(x, "r", encoding="utf8") as w:
                                e.delete(0.0, END)
                                root.title(os.path.basename(x) + " - PyEdit Text Editor")
                                e.insert(END, w.read())
                        except:
                            messagebox.showerror("Open file", "Could not open that file.")
                            return
